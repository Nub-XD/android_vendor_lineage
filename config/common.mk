...
CR_VERSION := 6-AUG23-OF

LINEAGE_VERSION := crDroid-rev-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(PRODUCT_CR_EXTRAVERSION)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)-v$(CR_VERSION)
LINEAGE_DISPLAY_VERSION := crDroid-rev-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(PRODUCT_CR_EXTRAVERSION)-$(LINEAGE_BUILD)-v$(CR_VERSION)
