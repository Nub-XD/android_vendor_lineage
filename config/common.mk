...
ifeq ($(WITH_GMS),true)
    PRODUCT_CR_EXTRAVERSION := GAPPS
else
    PRODUCT_CR_EXTRAVERSION := VANILLA
endif

ifeq ($(WITH_GMS_MINIMAL),true)
    PRODUCT_CR_EXTRAVERSION := CORE
endif

LINEAGE_VERSION := crDroidAndroid-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(PRODUCT_CR_EXTRAVERSION)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)-v$(CR_VERSION)
LINEAGE_DISPLAY_VERSION := crDroidAndroid-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(PRODUCT_CR_EXTRAVERSION)-$(LINEAGE_BUILD)-v$(CR_VERSION)
